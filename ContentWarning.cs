    ...
    public class ContentWarning : SimpleTCPPack
    {
        ...
        public override EffectList Effects => new List<Effect>
        {
                ...
                */
                ...
                new Effect("Give Crewmember Hugger", "cgiveitem_9") { Category = "Items"},
                new Effect("Give Crewmember Long Flashlight", "cgiveitem_11") { Category = "Items"},
                new Effect("Give Crewmember Party Popper", "cgiveitem_16") { Category = "Items"},
                new Effect("Give Crewmember Shockstick", "cgiveitem_18") { Category = "Items"},
                new Effect("Give Crewmember Sound Player", "cgiveitem_19") { Category = "Items"},
                new Effect("Give Crewmember Chorby", "cgiveitem_28") { Category = "Items"},
                new Effect("Give Crewmember Brain on a Stick", "cgiveitem_27") { Category = "Items"},
                new Effect("Give Crewmember Radio", "cgiveitem_31") { Category = "Items"},
                new Effect("Give Crewmember Spine", "cgiveitem_34") { Category = "Items"},
