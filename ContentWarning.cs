    ...
    public class ContentWarning : SimpleTCPPack
    {
        ...
        public override EffectList Effects => new List<Effect>
        {
                ...
                */
                ...
                new Effect("Give Crewmember Shockstick", "cgiveitem_19") { Category = "Items"},
                new Effect("Give Crewmember Sound Player", "cgiveitem_20") { Category = "Items"},
                new Effect("Give Crewmember Chorby", "cgiveitem_30") { Category = "Items"},
                new Effect("Give Crewmember Brain on a Stick", "cgiveitem_29") { Category = "Items"},
                new Effect("Give Crewmember Radio", "cgiveitem_33") { Category = "Items"},
                new Effect("Give Crewmember Skull", "cgiveitem_35") { Category = "Items"},
