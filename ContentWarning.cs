    ...
    public class ContentWarning : SimpleTCPPack
    {
        ...
        public override EffectList Effects => new List<Effect>
        {
                ...
                */
                ...
                new Effect("Give Shockstick", "giveitem_20") { Category = "Items"},
                new Effect("Give Sound Player", "giveitem_21") { Category = "Items"},
                new Effect("Give Chorby", "giveitem_32") { Category = "Items"},
                new Effect("Give Brain on a Stick", "giveitem_31") { Category = "Items"},
                new Effect("Give Radio", "giveitem_35") { Category = "Items"},
                new Effect("Give Skull", "giveitem_39") { Category = "Items"},

                new Effect("Give Crewmember Boom Mic", "cgiveitem_0") { Category = "Items"},
                new Effect("Give Crewmember Camera", "cgiveitem_1") { Category = "Items"},
                new Effect("Give Crewmember Clapper", "cgiveitem_3") { Category = "Items"},
                new Effect("Give Crewmember Defibrilator", "cgiveitem_4") { Category = "Items"},
                new Effect("Give Crewmember Flare", "cgiveitem_7") { Category = "Items"},
                new Effect("Give Crewmember Gooball", "cgiveitem_8") { Category = "Items"},
                new Effect("Give Crewmember Hugger", "cgiveitem_10") { Category = "Items"},
                new Effect("Give Crewmember Long Flashlight", "cgiveitem_12") { Category = "Items"},
                new Effect("Give Crewmember Party Popper", "cgiveitem_17") { Category = "Items"},
                new Effect("Give Crewmember Shockstick", "cgiveitem_20") { Category = "Items"},
                new Effect("Give Crewmember Sound Player", "cgiveitem_21") { Category = "Items"},
                new Effect("Give Crewmember Chorby", "cgiveitem_32") { Category = "Items"},
                new Effect("Give Crewmember Brain on a Stick", "cgiveitem_31") { Category = "Items"},
                new Effect("Give Crewmember Radio", "cgiveitem_35") { Category = "Items"},
                new Effect("Give Crewmember Skull", "cgiveitem_39") { Category = "Items"},
