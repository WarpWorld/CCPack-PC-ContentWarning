...
namespace CrowdControl.Games.Packs.ContentWarning
{
    ...
    public class ContentWarning : SimpleTCPPack
    {
        ...
        public override EffectList Effects => new List<Effect>
        {
                ...
                new Effect("Kill a Teammate", "killcrew") { Category = "Health", "Teammate Only"},
                ...
                */
                ...
                new Effect("Teleport a Teammate to Player", "telecrew") { Category = "Movement", "Teammate Only"},
                new Effect("Teleport Player to Dive Bell", "teletobell") { Category = "Movement"},
                new Effect("Teleport a Teammate to Dive Bell", "telecrewbell") { Category = "Movement", "Teammate Only"},
                ...
                */
                ...
                new Effect("Give Teammate Boom Mic", "cgiveitem_0") { Category = "Items", "Teammate Only"},
                new Effect("Give Teammate Camera", "cgiveitem_1") { Category = "Items", "Teammate Only"},
                new Effect("Give Teammate Clapper", "cgiveitem_3") { Category = "Items", "Teammate Only"},
                new Effect("Give Teammate Defibrilator", "cgiveitem_4") { Category = "Items", "Teammate Only"},
                new Effect("Give Teammate Flare", "cgiveitem_7") { Category = "Items", "Teammate Only"},
                new Effect("Give Teammate Gooball", "cgiveitem_8") { Category = "Items", "Teammate Only"},
                new Effect("Give Teammate Hugger", "cgiveitem_10") { Category = "Items", "Teammate Only"},
                new Effect("Give Teammate Long Flashlight", "cgiveitem_12") { Category = "Items", "Teammate Only"},
                new Effect("Give Teammate Party Popper", "cgiveitem_17") { Category = "Items", "Teammate Only"},
                new Effect("Give Teammate Shockstick", "cgiveitem_19") { Category = "Items", "Teammate Only"},
                new Effect("Give Teammate Sound Player", "cgiveitem_20") { Category = "Items", "Teammate Only"},
                new Effect("Give Teammate Chorby", "cgiveitem_30") { Category = "Items", "Teammate Only"},
                new Effect("Give Teammate Brain on a Stick", "cgiveitem_29") { Category = "Items", "Teammate Only"},
                new Effect("Give Teammate Radio", "cgiveitem_33") { Category = "Items", "Teammate Only"},
                new Effect("Give Teammate Skull", "cgiveitem_35") { Category = "Items", "Teammate Only"},
                ...
                new Effect("Spawn Jello at Teammate", "cspawn_Jello") { Category = "Monsters", "Teammate Only"},
                new Effect("Spawn Zombie at Teammate", "cspawn_Zombe") { Category = "Monsters", "Teammate Only"},
                new Effect("Spawn Spider at Teammate", "cspawn_Spider") { Category = "Monsters", "Teammate Only"},
                new Effect("Spawn Snatcho at Teammate", "cspawn_Snatcho") { Category = "Monsters", "Teammate Only"},
                new Effect("Spawn Bombs at Teammate", "cspawn_Bombs") { Category = "Monsters", "Teammate Only"},
                new Effect("Spawn Barnacle Ball at Teammate", "cspawn_BarnacleBall") { Category = "Monsters", "Teammate Only"},
                new Effect("Spawn Dog at Teammate", "cspawn_Dog") { Category = "Monsters", "Teammate Only"},
                new Effect("Spawn Ear at Teammate", "cspawn_Ear") { Category = "Monsters", "Teammate Only"},
                new Effect("Spawn Big Slap at Teammate", "cspawn_BigSlap") { Category = "Monsters", "Teammate Only"},
                new Effect("Spawn Eye Guy at Teammate", "cspawn_EyeGuy") { Category = "Monsters", "Teammate Only"},
                new Effect("Spawn Flicker at Teammate", "cspawn_Flicker") { Category = "Monsters", "Teammate Only"},
                new Effect("Spawn Harpoon at Teammate", "cspawn_Harpoon") { Category = "Monsters", "Teammate Only"},
                new Effect("Spawn Mouthe at Teammate", "cspawn_Mouthe") { Category = "Monsters", "Teammate Only"},
                new Effect("Spawn Whisk at Teammate", "cspawn_Whisk") { Category = "Monsters", "Teammate Only"},
                new Effect("Spawn Weeping at Teammate", "cspawn_Weeping") { Category = "Monsters", "Teammate Only"},
